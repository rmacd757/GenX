...
for i in task_id+1:num_tasks:length(all_cases)
    emiss_lim = all_cases[i][1]
    fusion_cap = all_cases[i][2]
    ...
    try
        ...
        println("Run failed using Emiss Limit: $emiss_lim, Fusion Cap: $fusion_cap")
    end
end
