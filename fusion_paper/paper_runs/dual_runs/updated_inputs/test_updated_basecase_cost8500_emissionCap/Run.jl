...
input_name = "test_updated_basecase_cost8500_emissionCap"
case_name = "test_updated_basecase_cost8500_emissionCap"
...
for idx in 1:1:length(emiss_lim_list)
    ...
    myinputs["dfMaxCO2Rate"][2] = emiss_lim / scale_factor ./ 1e3 .* 2.0
    outputs_path = joinpath(results_path, "Cost_8500_EmissLevel_$(emiss_lim)_gCO2perkWh")
