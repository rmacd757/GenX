...
case_path = joinpath("D:\\", "Dropbox", "1_Academics", "Research", "19-Fusion_resilience_ENI", "Fusion Resilience Study - Shared", "7-GenX Optimizations", "primal_runs", "corrected_battery_no_vre_cap", case_name)
...
for emiss_lim in emiss_lim_list
    ...
    outputs_path = joinpath(case_path, "Results", "Primal_Baseline_EmissLevel_" * string(emiss_lim))
