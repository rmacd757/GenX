...
input_name = "primal_2zone_20year_flexNG_baseloadfpp"
case_name = "primal_2zone_20year_flexNG_baseloadfpp"
...
for emiss_lim in emiss_lim_list
    ...
    @constraint(EP, cFPPCapFactor[y in fusion_rid], sum(EP[:vP][y,t] for t in 1:myinputs["T"]) >= 0.85 * EP[:eTotalCap][y] * 190.0 / 263.0 * 8760.0 * 20.0)
