...
inputs_path = joinpath(pwd(),"fusion_runs","data","primal_6zoneandQC_baseline_lowHydroInflows")
...
for emiss_lim in emiss_lim_list
    ...
    outputs_path = joinpath(case_path, "Results", "Primal_Baseline_noEmissLim_lowHydroInflows")
