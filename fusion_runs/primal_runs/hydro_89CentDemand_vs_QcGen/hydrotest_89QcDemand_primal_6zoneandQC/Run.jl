...
input_name = "hydrotest_89QcDemand_primal_6zoneandQC"
case_name = "hydrotest_primal_6zoneandQC"

# THIS MUST BE RESET FOR EACH COMPUTER RUNNING THE CODE
case_path = dirname(@__FILE__)

# Home the home directory, to let us load the run_helpers.jl file
path_split = split(case_path,"/")
home_dir = ""
for s in path_split
    if s == "fusion_runs"
